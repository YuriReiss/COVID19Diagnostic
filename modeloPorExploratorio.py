...
# Definindo o modelo
model = Sequential([
    Conv2D(8, 3, input_shape=(100, 100, 1), activation='relu'),  # Apenas 1 canal (tons de cinza)
    MaxPooling2D(),
...
plt.savefig('m_confusion_matrix_train_5.png')
t2.plot()
plt.title('Matriz de confusão do teste')
plt.savefig('m_confusion_matrix_test_5.png')
...
model.save("models/CovidDiagnostic_PorExploratorio.keras")